---
name: hig-patterns
description: 'Apple Human Interface Guidelines interaction and UX patterns. Use this skill when the user asks about , , , , , , , , , , , , , , data entry, sharing, collaboration, full screen, audio, video, haptic feedback, ratings, printing, help, or account management in Apple apps. Also use when the user says , , , , , , or . Cross-references: hig-foundations for underlying principles, hig-platforms for platform specifics, hig-components-layout for navigation, hig-components-content for data display.'
metadata:
  author: ncdevshiv
  version: "1.0.0"
  category: other
